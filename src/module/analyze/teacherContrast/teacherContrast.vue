    ...
    <div class="content">
      ...
      <div class="selects group asbox">
        ...
        <div>
          ...
          <div class="Select" id='select7' :style="selectStyle[2]"></div>
...
<script>
  ...
  import {termSelect, teacherSelect, selectStyle, findLessonsEventInfo, getOnClassStudentsStatusForTeacher, getTeachingModel, findLessonAttendanceRate} from '@/module/analyze/config'
    ...
    methods: {
        ...
        if (_this.teacherId1 && _this.teacherId2) {
          ...
          _this.axios({
            ...
            .then((res) => {
              let data = res.data
              if (data && data.isSuccess === 1) {
                _this.btmRight1[0] = parseInt(data.attendanceRates)
          ...
          _this.axios({
            ...
            .then((res) => {
              let data = res.data
              if (data && data.isSuccess === 1) {
                _this.btmRight2[0] = parseInt(data.attendanceRates)
                _this.$refs.btmRightBarChart.setEcharts()
              }
            })
            .catch(() => {
      ...
      getTeacherId (obj, num) {
        if (num === 0) {
          ...
          this.topName1 = obj.info.teacherName

          this.leftTeacherInfo.realName = obj.info.teacherName
          if (obj.info.gender === 2) {
            this.leftTeacherInfo.sex = '女'
          } else if (obj.info.gender === 1) {
            this.leftTeacherInfo.sex = '男'
          }
          this.leftTeacherInfo.collegeName = obj.collegeName
          this.leftTeacherInfo.code = obj.info.code
          this.leftTeacherInfo.httpUrl = obj.info.iconUrl
        } else if (num === 1) {
          this.teacherId2 = obj.value
          this.topName2 = obj.info.teacherName
          this.rightTeacherInfo.realName = obj.info.teacherName
          if (obj.info.gender === 2) {
            this.rightTeacherInfo.sex = '女'
          } else if (obj.info.gender === 1) {
            this.rightTeacherInfo.sex = '男'
          }
          this.rightTeacherInfo.collegeName = obj.collegeName
