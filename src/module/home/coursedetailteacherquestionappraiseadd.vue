...
import {resdiscussurl, pathinfodetail, discusspartinfo} from '@/module/home/config/courseinfo'
export default {
  ...
  methods: {
    ...
    cancelfn () {
      this.$router.push({name: pathinfodetail.prex, params: {recall: 'getquestion'}, query: {courseId: this.geturlparam('courseId', location.hash), lessonId: this.geturlparam('lessonId', location.hash), resourceid: this.geturlparam('resourceid', location.hash)}})
    },
