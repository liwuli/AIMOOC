      ...
      <div class="centers1100">
        ...
        <div class="cdetail_left" style="width: 100%;">
          <div class="video" id="filesee" style="height: 616px;">
          	<!--<iframe frameborder="0" id="fileseeiframe" :urls="fileinfo.resourceLocation" scrolling="no" src="/static/pdf/web/viewer2.html" width="100%" height="616px"></iframe>-->
          </div>
  ...
  methods: {
    ...
    getres () {
      ...
      .then(function (res) {
        ...
        let dom = '<iframe frameborder="0" id="fileseeiframe" urls="' + that.fileinfo.resourceLocation + '" scrolling="no" src="/static/pdf/web/viewer2.html" width="100%" height="616px"></iframe>'
        document.getElementById('filesee').innerHTML = dom
      })
      .catch(function (error) {
        console.log(error)
      })
