    ...
    <div class="center centerbottom50">
      <div class="centers1100"  :style="'min-height:' + Mlefthei + 'px;'">
        ...
        <div class="livedetailcenter">
            ...
            <div class="download" @click="download($event)">
							<span class="staricon iconfont icon-download"></span>
							<span class="txt">{{liveinfo.download}}</span>
						</div>
					</div>
					<!-- <div class="chatpart">
						<div class="title">
...
import {faviratestateurl, favirateaddurl, livereviewurl, faviratedelurl, getmsglisturl, warntxt, liveinfo, chatinfo,detailinfo} from '@/module/home/config/liveinfo'
export default {
  ...
  methods: {
    ...
    download(res){
      ...
      this.$router.push({name: 'Flivedownlist', params: {item: obj, type: 0}})
    },

    go () {
      this.$router.push({name: 'Flivelived'})
    },
    getfaviratestate () {
      let that = this
      this.axios({
