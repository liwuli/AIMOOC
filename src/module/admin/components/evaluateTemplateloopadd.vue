<template>
 	<div class="formwin">
 		<div class="win_content" :style="'width:' + wininfo.widhei[0] + ';height:' + wininfo.widhei[1]">
 			<div class="title">
 				<span class="menuname">{{evaluateTemplateinfo.msgaddN}}</span>
...
import {pathinfo, addloopurl, warntxt, evaluateTemplateinfo} from '@/module/admin/config/evaluateTemplateloopinfo'
export default {
