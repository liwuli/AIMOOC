<template>
 	<div class="formwin">
 		<div class="win_content" :style="'width:' + wininfo.widhei[0] + ';height:' + wininfo.widhei[1]">
 			<div class="title">
 				<span class="menuname">{{loopclassgroupinfo.publish}}</span>
 				<span class="filename"></span>
 			</div>
 			<div class="winclose iconfont icon-guanbijiantou" @click="cancelfn"></div>
 			<div class="content" :style="'height:' + wininfo.contenthei">
			 	{{loopclassgroupinfo.publishcontent}}
 			</div>
 			<div class="btnline">
...
import {loopclassgroupinfo, setmemeberurl, relassistantpathinfo} from '@/module/admin/config/GroupLoopManageinfo'
export default {
