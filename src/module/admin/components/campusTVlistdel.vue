<template>
 	<div class="formwin">
 		<div class="win_content" :style="'width:' + wininfo.widhei[0] + ';height:' + wininfo.widhei[1]">
 			<div class="title">
 				<span class="menuname">{{schoolradioinfo.del}}</span>
 			...
 			<div class="btnline">
 				...
 				<div class="save" @click="savedata">{{schoolradioinfo.del}}</div>
 			</div>
 		</div>
 	</div>
</template>
...
import {programpathinfo, programdelurl, schoolradioinfo} from '@/module/admin/config/campusTVlistinfo'
export default {
