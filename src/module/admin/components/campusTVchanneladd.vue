<template>
 	<div class="formwin">
 		<div class="win_content" :style="'width:' + wininfo.widhei[0] + ';height:' + wininfo.widhei[1]">
 			<div class="title">
 				<span class="menuname">{{channelinfo.channeladd}}</span>
...
import {channellistaddurl, pathinfo, channelinfo, channelwarntxt} from '@/module/admin/config/campusTVchannelinfo'
export default {
