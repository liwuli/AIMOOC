 	...
 	<div class="formwin">
 		<div class="win_content" :style="'width:' + wininfo.widhei[0] + ';height:' + wininfo.widhei[1]">
 			...
 			<div class="content" :style="'height:' + wininfo.contenthei">
			 	...
			 	<div class="formline">
			 		<span class="txt">{{basicinfo.codeN}}<i>*</i>：</span>
...
import {basicinfo, editurl, pathinfo, warntxt} from '@/module/admin/config/collegeinfo'
export default {
  name: 'AJcollegeedit',
  data () {
    return {
  ...
  methods: {
    valid () {
      if (this.name.replace(/\s/gi, '') === '') {
        ...
        return false
      } else if (this.code.replace(/\s/gi, '') === '') {
        ...
        this.axios({
          ...
          params: {
            par: {
              ...
              collegeName: that.name,
              collegeCode: that.code,
              collegeId: that.id
            }
          }
        })
