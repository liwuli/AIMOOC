 	...
 	<div class="formwin">
 		<div class="win_content" :style="'width:' + wininfo.widhei[0] + ';height:' + wininfo.widhei[1]">
 			...
 			<div class="content" :style="'height:' + wininfo.contenthei">
			 	{{evaluateTemplateinfo.publish}}  {{name}}  {{evaluateTemplateinfo.ma}}
 			</div>
 			<div class="btnline">
...
import {pathinfo, publishurl, msgpublishN, contentN, cancelN, sureN, evaluateTemplateinfo} from '@/module/admin/config/evaluateTemplateinfo'
export default {
