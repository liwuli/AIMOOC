...
import {getgradesurl, assistantaddmemberurl, getcollegeurl, othermemeberurl, loopclassgroupinfo, relotherpathinfo, pageval, relassistantcolumsadd, relassistantcolumsaddP, relassistantpercentinfoadd, relassistantlistheadadd, relassistantlistheadaddP, pagesize} from '@/module/admin/config/GroupLoopManageinfo'
export default {
  ...
  computed: {
    listhead () {
      return this.eduType ? relassistantlistheadadd : relassistantlistheadaddP
    },
    colums () {
      return this.eduType ? relassistantcolumsadd : relassistantcolumsaddP
    }
  },
  components: {
    List
