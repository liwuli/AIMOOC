...
import {basicinfo, bingos, pageval, optobjinfoAManageshow, optobjinfoAManage, pathinfo, opteventAManage, percentinfoAManage, columsAManage, pagesizeten, listheadAManage, getpassseturl, pathinfoManage, statearrManage, typearr, roomurl} from '@/module/admin/config/appointinfo'
export default {
        ...
        for (let i = 0; i < objs.length; i++) {
          if (i < pagesizeten) {
            temp.push({
              ...
              opt: that.optobjinfo,
              selected: false,
              show: objs[i].status !== '0' ? optobjinfoAManageshow : false,
