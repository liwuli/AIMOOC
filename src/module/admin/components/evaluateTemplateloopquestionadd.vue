 		...
 		<div class="win_content" :style="'width:' + wininfo.widhei[0] + ';height:' + wininfo.widhei[1]">
 			...
 			<div class="content" :style="'height:' + wininfo.contenthei">
			 	<div class="formline">
			 		...
			 		<textarea class="textarea" :placeholder="evaluationtempletsetinfo.placeholdertitle" name="" v-model="title" style="width: 476px;" rows="" cols=""></textarea>
			 	</div>
 			</div>
 			<div class="btnline">
...
export default {
  name: 'AJevaluateTemplateloopQuestionadd',
  data () {
    return {
      wininfo: {
        widhei: ['600px', '280px'],
