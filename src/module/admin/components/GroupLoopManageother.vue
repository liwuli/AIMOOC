    ...
    <div class="center centerbottom50">
    	<div class="centers">
    		...
    		<div class="AA_right">
              ...
              <span class="txt" style="line-height: 30px;">{{eduType?loopclassgroupinfo.collegeN:loopclassgroupinfo.gradeN}}:</span>
...
import {getgradesurl, collegemajorurl, leaderlisturl, loopclassgroupinfo, totalnum, pagesize, pageval, bingos, relotherpathinfo, relotherlisthead, relotherlistheadP, relothercolums, relothercolumsP, products, relotherpercentinfo, relassistantopteventAll, relassistantoptobjinfoAll, relassistantopteventAllcancel, relassistantoptobjinfoAllcancel} from '@/module/admin/config/GroupLoopManageinfo'
export default {
  ...
  data () {
    return {
      ...
      bingos: bingos,
      pageinfo: 0,
      pathinfo: relotherpathinfo,
      products: products,
      percentinfo: relotherpercentinfo,
      name: '',
      college: '',
      major: '',
      collegeobj: '',
  ...
  computed: {
    listhead () {
      return this.eduType ? relotherlisthead : relotherlistheadP
    },
    colums () {
      return this.eduType ? relothercolums : relothercolumsP
    }
  },
  created () {
...
//  AJposition,
  ...
  methods: {
    ...
    add () {
      this.$router.push({name: relotherpathinfo.prex + 'add', query: {ClassGroupId: this.loopClassGroupId, collegeid: this.college, groupType: this.grouptype}})
    }
  },
  watch: {
    '$route' (to, from) {
      if (to.name === relotherpathinfo.prex) {
