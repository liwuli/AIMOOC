 		...
 		<div class="win_content" :style="'width:' + wininfo.widhei[0] + ';height:' + wininfo.widhei[1]">
 			...
 			<div class="content" :style="'height:' + wininfo.contenthei">
			 	...
			 	<div class="formline" >
			 		...
			 		<input type="number" :placeholder="evaluationtempletsetinfo.placeholderscole" min="0" v-model="scole" style="width: 476px;"/>
			 	</div>
 			</div>
 			<div class="btnline">
...
export default {
  name: 'AJevaluateTemplateloopScoleadd',
  data () {
    return {
      wininfo: {
        widhei: ['600px', '280px'],
