 	...
 	<div class="formwin">
 		<div class="win_content" :style="'width:' + wininfo.widhei[0] + ';height:' + wininfo.widhei[1]">
 			...
 			<div class="content" :style="'height:' + wininfo.contenthei">
			 	<div class="formline">
			 		<span class="txt">{{basicinfo.subjectNameN}}<i>*</i>：</span>
			 		<input type="text"  v-model="subjectName" :value="subjectName"/>
			 	</div>
			 	<div class="formline">
...
import {basicinfo, warntxt, pathinfo, editurl} from '@/module/admin/config/subjectinfo'
export default {
  name: 'AJsubjectedit',
  data () {
    return {
  ...
  methods: {
    valid () {
      if (this.subjectName.replace(/\s/gi, '') === '') {
        this.win(warntxt.subjectName, '', false)
        return false
      } else {
        return true
      }
