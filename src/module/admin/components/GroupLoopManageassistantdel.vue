 	...
 	<div class="formwin">
 		<div class="win_content" :style="'width:' + wininfo.widhei[0] + ';height:' + wininfo.widhei[1]">
 			...
 			<div class="content" :style="'height:' + wininfo.contenthei">
			 	{{loopclassgroupinfo.contentassistant}}
 			</div>
 			<div class="btnline">
...
import {loopclassgroupinfo, delmemberurl, relassistantpathinfo} from '@/module/admin/config/GroupLoopManageinfo'
export default {
  name: 'AJGroupLoopManagerelassistantdel',
  data () {
    return {
      msg: loopclassgroupinfo.deluser,
