...
import {labelinfo, cancelN, getlabelsurl} from '@/module/admin/config/courseinfo'
export default {
  ...
  methods: {
    savedatalabel () {
      if (this.edit === 'edit') {
        this.$router.push({name: 'AJcourseedit', params: {selectarr: this.idstring, info: this.info}})
      } else {
        this.$router.push({name: 'AJcourseadd', params: {selectarr: this.idstring}})
      }
    },
    getlabel () {
      let that = this
