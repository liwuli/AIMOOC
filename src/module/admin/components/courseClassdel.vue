<template>
 	<div class="formwin">
 		<div class="win_content" :style="'width:' + wininfo.widhei[0] + ';height:' + wininfo.widhei[1]">
 			<div class="title">
 				<span class="menuname">{{msgdelN}}</span>
...
import {dellessonurl, msgClassDelN, delN, cancelN} from '@/module/admin/config/courseinfo'
export default {
  name: 'AJcoursedeldetail',
  data () {
    return {
      msgdelN: msgClassDelN,
      contentN: '是否要删除此章节对应所有资源',
      delN: delN,
      cancelN: cancelN,
      wininfo: {
        widhei: ['300px', '270px'],
