...
import {basicinfo, warntxt, pathinfo, evaluationtempletsetinfo, editurl} from '@/module/admin/config/labelinfo'
export default {
  name: 'AJlabeledit',
  data () {
    return {
    ...
    savedata () {
      ...
      .then(function (res) {
        if (res.data.code !== 200) {
          ...
          that.$router.push({name: 'AJlabel', params: {ind: that.$route.params.ind, name: groupName}})
        }
      })
