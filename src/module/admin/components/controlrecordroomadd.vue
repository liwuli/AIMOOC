...
import {basicinfo, pathinfo, saveurl, pagesize, percentinfo1, colums, listhead1, buildingurl} from '@/module/admin/config/controlrecordinfo'
export default {
  name: 'AJcontrolrecordaddroom',
  data () {
    return {
