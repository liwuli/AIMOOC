...
export const yes = '是'
export const no = '否'
export const contentN = '确定要删除选中的章节吗？'
...
export const recordStatus = ['未录制', '录制中', '录制完成']
export const optobjinfoAll = ['编辑', '删除', '查看']
export const opteventAll = ['editlist', 'dellist', 'see']
export const listheadoptinfoAll = ['添加', '修改', '删除', '管理']
export const listheadoptoptAll = ['headoptadd', 'headoptedit', 'headoptdel', 'Mlist']
export const listheadoptinfoAllversion12 = ['添加', '修改', '删除']
export const listheadoptoptAllversion12 = ['headoptadd', 'headoptedit', 'headoptdel']
export const pathinfo = {'prex': 'AJcourselessonlist', 'optname': '节次管理'}
export const weekType = [{name: '全部', value: 'all'}, {name: '单周', value: 'single'}, {name: '双周', value: 'double'}]
// 普教-校内课程
export const listhead = ['check', '章节名称', '讲师', '教室', '星期', '节次', '上课时间', '状态', '操作']
export const colums = ['check', 'name', 'teacher', 'classroom', 'week', 'lesson', 'stime', 'status', 'opt']
export const percentinfo = ['wid5', 'wid15', 'wid10', 'wid15', 'wid5', 'wid5', 'wid15', 'wid10', 'wid20']
// 高教-校内课程
export const listheadG = ['check', '章节名称', '讲师', '教室', '星期', '节次', '上课时间', '状态', '操作']
export const columsG = ['check', 'name', 'teacher', 'classroom', 'week', 'lesson', 'stime', 'status', 'opt']
export const percentinfoG = ['wid5', 'wid15', 'wid10', 'wid15', 'wid5', 'wid5', 'wid15', 'wid10', 'wid20']
