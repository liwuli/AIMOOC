...
import {warntxt, pathinfo, champteraddN, champteraddnameN, saveN, cancelN, addchampterurl} from '@/module/admin/manage/config/Mcourseinfo'
export default {
  name: 'AJMcourseManagechampteradd',
  data () {
    return {
      msg: champteraddN,
