...
import {pathinfo, champterresdelN, delN, cancelN, delcontentN, delchampterresourceurl} from '@/module/admin/manage/config/Mcourseinfo'
export default {
  name: 'AJMcourseManagechampterresdel',
  data () {
    return {
      msg: champterresdelN,
      wininfo: {
