...
//	console.log('这里调用的是js风格')
	var ck = {
		...
		*/
		...
		setup: '0,0,1,1,1,2,0,1,0,0,1,1,1000,0,2,1,0,0,0,0,0,10,3,0,0,2,0,0,2,0,0,0,0,1,1,1,1,250,0,90,0,0,0',
		/*
	...
	var CKobject = {
		...
		embedSWF: function(C, D, N, W, H, V, P) {
			...
			var u = 'undefined',
				...
				t = '<br><a href="' + r + '" target="_blank" style="color:#fff">点击此处下载插件</a>',
				error = {
					w: '您的网页不符合w3c标准，无法显示播放器',
					f: '<div class="verticalcenter" style=" height: 40px;line-height:20px;width: 100%;left: 0; bottom: 0; right: 0; position: absolute;top: 0;color: #fff;margin: auto;">您没有安装flash插件，无法播放视频，' + t+'</div>',
